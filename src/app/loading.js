...
const loading = () => {
    return (
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 bg-emerald-500/10 blur-[150px] rounded-full pointer-events-none animate-pulse" />
      ...
      <div className="relative flex flex-col items-center z-10 scale-110">
        ...
        <div className="text-center mt-4 space-y-1">
          ...
          <h2 className="text-3xl font-black italic tracking-tighter uppercase bg-linear-to-r from-white via-slate-200 to-lime-400 bg-clip-text text-transparent drop-shadow-sm">
            Gearing Up
          </h2>
