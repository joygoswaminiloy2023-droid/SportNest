...
const notfound = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-950 text-white font-sans select-none overflow-hidden relative px-4">
      ...
      {/* Stadium Red Card/Warning Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-red-500/10 blur-[180px] rounded-full pointer-events-none" />

      <div className="relative flex flex-col items-center z-10 text-center max-w-md">
        
        {/* Big Sporty 404 Graphic */}
        <div className="relative mb-6">
          <h1 className="text-9xl font-black italic tracking-tighter text-slate-800 uppercase select-none opacity-40">
            404
          </h1>
          {/* Badge Overlay */}
        ...
        {/* Referee/Game Over Style Message */}
        <div className="space-y-3">
          <h2 className="text-3xl font-black italic uppercase tracking-tight bg-gradient-to-r from-white via-slate-100 to-red-500 bg-clip-text text-transparent">
            Whistle Blown!
          </h2>
          <p className={newFunction()}>
            The page you are looking for has been benched, traded, or never made the roster. Let&lsquo;s get you back in the game.
          </p>
        </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 w-full justify-center">
          <Link 
            href="/"
            className="px-6 py-3 bg-linear-to-r from-lime-400 to-emerald-500 text-slate-950 font-black italic uppercase tracking-wider rounded text-sm hover:from-lime-300 hover:to-emerald-400 transition-all duration-200 shadow-[0_4px_20px_rgba(163,230,53,0.3)] hover:scale-105 active:scale-95 text-center"
          >
      ...
      {/* Decorative Field Lines background detail */}
